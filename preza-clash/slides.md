...
Clash --- это HDL на основе Haskell, позволяющий проводить симмуляцию и компилировать код в традиционные HDL (VHDL, Verilog, SystemVerilog).
...
Clash --- Это диалект Haskell, подменяет стандартную библиотеку, но все основные конструкции можно использовать.
